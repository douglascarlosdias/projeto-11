...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
  <div class="wrapper">
            ...
            <a href="#" class="dropdown-item">
              ...
              <div class="media">
                ...
                <div class="media-body">
                  ...
                  <p class="text-sm"></p>
                  <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i>Último Pedido: 10-05/2023</p>
                </div>
              </div>
              <!-- Message End -->
            </a>
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; 2023 <a href="../index.php">Tio Gôga Pizzaria</a>.</strong>
